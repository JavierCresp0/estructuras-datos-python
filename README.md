...
Prácticas de la asignatura **Estructura de Datos** (2º curso) implementadas en **Python**. Se trabajan **Tipos Abstractos de Datos (TADs)** y estructuras clásicas desde cero, sin depender de las del lenguaje.
...
- **Lenguaje:** Python 3
- **Paradigma:** Programación orientada a objetos aplicada a TADs
...
📌 *Prácticas del 2º curso del Grado en Ingeniería Informática — Universidad Miguel Hernández.*
